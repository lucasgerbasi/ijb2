...
const AtualizarInformacoes = () => {
    ...
    const atualizarFamilia = async () => {
        console.log('Confirmar clicado'); // Log para verificar se o botão está funcionando
        ...
        try {
            console.log('Atualizando família com os dados: ', data); // Log para verificar os dados antes da requisição
